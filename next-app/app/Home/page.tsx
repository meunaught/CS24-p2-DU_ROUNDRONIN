...
const Home = () => {
      return (
            <div className="w-full h-[100vh] flex flex-row justify-center items-center pl-[10%] pr-[10%]">
                  <div className="left w-[40%] h-full flex flex-col justify-center mt-[5%] items-start ">
                        <img className="w-[80%]" src="/Image/homefig.svg" alt="Home Figure" />
                  </div>
                  <div className="w-[60%] h-full flex flex-col justify-center mt-[5%] items-start ">
